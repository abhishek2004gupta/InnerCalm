...
# Load dataset
with open(r'D:\Hackathon\AI Mavericks\InnerCalm\dataset2 (1).json') as f:
...
# # Load dataset
# with open(r'D:\Hackathon\AI Mavericks\7_AI-Mavericks_HealthandWellBeing-main\dataset2 (1).json') as f:
#     intents = json.load(f)["intents"]
...
# # load_model_and_start_chat()  # Load model and start chat
